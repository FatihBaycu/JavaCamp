...
public class HWCKPSPublicSoap
{
    ...
    public HWCKPSPublicSoap(){}

    public HWCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HWCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HWCExtendedSoapSerializationEnvelope envelope= new HWCExtendedSoapSerializationEnvelope(HWCExtendedSoapSerializationEnvelope.VER11);
